...
ifstream file("../ALL_IN.txt"); // �滻������ļ�����·��
//ifstream file("../CHINESE7000_OUT.txt"); // �滻������ļ�����·��
ofstream outFile("../name_tmp.txt");
ofstream out_chinese_array("../chinese_array.txt");
ofstream output_file("../chinses_map.txt"); // �ļ������Ը��������Ҫ����
string names[10000];
...
void back_font(int num_show, unsigned char *font) { //ѹ��ת�Դ���ʾ
...
//    return 0;
    ...
    int now_bit_index = 0;
    for (int k = 0; k < CHN_FONT_NUM; k++) {//ѹ��
        unsigned char bitmap[CHN_FONT_HIGH][CHN_FONT_WIDTH] = {0};
        for (int i = 0; i < CHN_FONT_WIDTH * 2; i++) {
            if (i < CHN_FONT_WIDTH) {
                for (int j = 0; j < 8; j++) {
